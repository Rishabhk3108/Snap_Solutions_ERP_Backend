...
class FaceEncoding(Base):
    ...
    encoding = Column(Text, nullable=False)  # JSON array of 128 floats (dlib legacy, "[]" for Azure registrations)
    photo = Column(Text, nullable=True)      # base64 JPEG: compressed full photo (Azure) or face crop (PIL legacy)
