...
def _serialize(f: UserFinancialInfo) -> dict:
    return {
        ...
        "allowanceFuel": f.allowance_fuel,
        "allowancePhoneBill": f.allowance_phone_bill,
...
def salary_update(db: Session, user_id: int, salary_basic: int, salary_gross: int, salary_net: int):
    ...
    new_record = UserFinancialInfo(
        ...
        allowance_fuel=existing.allowance_fuel,
        allowance_phone_bill=existing.allowance_phone_bill,
...
def _build(body: dict) -> UserFinancialInfo:
    return UserFinancialInfo(
        ...
        allowance_fuel=body.get("allowanceFuel"),
        allowance_phone_bill=body.get("allowancePhoneBill"),
...
def _apply(fi: UserFinancialInfo, body: dict):
    field_map = {
        ...
        "allowanceFuel": "allowance_fuel", "allowancePhoneBill": "allowance_phone_bill",
